...
public class UserForm extends BorderPane {
    ...
    private ListView<com.example.rprlab78.Korisnik> userList;
    ...
    private ButtonBar createButtonBar() {
        ...
        dodajButton.setOnAction(event -> {
            com.example.rprlab78.Korisnik newUser = new com.example.rprlab78.Korisnik();
    ...
    private void showUserDetails(com.example.rprlab78.Korisnik user) {
